			...
			.exec(function(err, questions){
				if (err){
					...
					function filterQuestion(question){
						return (question.sample.specimenType == request.query.specimenType && request.query.environmentType === null) || (question.sample.environmentType == request.query.environmentType && request.query.specimenType === null) || (question.sample.environmentType == request.query.environmentType && question.sample.specimenType == request.query.specimenType);
					}
